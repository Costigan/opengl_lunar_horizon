...
namespace lunar_horizon.terrain
{
    public class Horizon
    {
        ...
        public float OverHorizon(float azimuth_rad, float elevation_deg)
        {
            ...
            var horizon_deg = elevation_left + frac * (elevation_right - elevation_left);
            return elevation_deg - horizon_deg;
        }
