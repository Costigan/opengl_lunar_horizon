...
namespace lunar_horizon.terrain
{
    ...
    {
        public const int IdBoundMinusOne = patches.TerrainPatch.DEM_size / patches.TerrainPatch.DefaultSize - 1;
        public const int Size = 4; // patches.TerrainPatch.DefaultSize;
