...
namespace lunar_horizon.viz
{
    public abstract class Shape
    {
        ...
        public float[] Specularity = { 0f, 0f, 0f };
        ...
        public VBO LoadVBO<TVertex>(TVertex[] vertices, ushort[] elements, InterleavedArrayFormat format) where TVertex : struct
        {
        ...
        {
            var nearpos = (pos - eye) * 1000000d;  // from units of 1000km to meters
        ...
        {
            Vector3.Subtract(ref a, ref b, out Vector3 temp1);
            temp1.Normalize();
            Vector3.Subtract(ref c, ref b, out Vector3 temp2);
            temp2.Normalize();
