...
namespace lunar_horizon.viz
{
    public class ShaderProgram
    {
        ...
        public int mvpMatrixLocation, mvMatrixLocation, mMatrixLocation;
        ...
        private void BindTexture(ref int textureId, TextureUnit textureUnit, string uniformName)
        {
            ...
            var loc = GL.GetUniformLocation(Handle, uniformName);
            if (loc > -1)
    ...
    {
        public int CenterXLocation, CenterYLocation, AngleFactorLocation;
        public float CenterX = 500f, CenterY = 500f, AngleFactor = 0.01f;
